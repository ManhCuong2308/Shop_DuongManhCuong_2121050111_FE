        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              CuongDollar Store - Nơi mang đến cho bạn những sản phẩm thời trang
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                Địa chỉ: số 19 ngách 46/31 Văn Hội, phường Đức Thắng, quận Bắc
                Từ Liêm
              </li>
            </ul>
          </div>
          <div>
            ...
            <div className="flex space-x-4">
              <SocialLink
                href="https://www.facebook.com/manhcuong230803"
                icon="facebook"
              />
